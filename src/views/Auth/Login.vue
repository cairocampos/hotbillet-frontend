          ...
          <div class="text-center py-16 space-y-10 w-full md:w-1/3 flex flex-col justify-between">
            <div class="flex items-center justify-center mb-10">
                <h3 class="text-4xl text-secondary font-semibold mr-0">
                  <img src="@/assets/logo.png" alt="Logo Hotbillet" width="250">
                </h3>
            </div>
            <form class="form space-y-12" @submit.prevent="login">
                <div class="form-group">
                  <div class="input-group form-control text-white border-2 border-gray-50 rounded-md">
                  ...
                  <div class="input-group form-control text-white border-2 border-gray-50 rounded-md">
                    <div class="input-prepend mr-2">
                      ...
                      <input v-model="password" 
                        ...
                        class="w-100 bg-transparent outline-none" />
                      <div class="input-append mr-2">
                        <button type="button" class="align-middle" @click="exibirSenha = !exibirSenha">
                          <svg v-if="exibirSenha" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="form-group text-center">
                    <div>
                      <button v-if="btnLoading" class="btn btn-circle btn-secondary">
