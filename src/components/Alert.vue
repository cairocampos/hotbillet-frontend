      ...
      >
        ...
        >
          <div class="body p-4 flex items-center justify-center flex-col space-y-10">
            ...
            >
              <path
                d="M170.968 24.0606C168.379 21.467 164.178 21.4625 161.588 24.0496L82.0127 103.415L53.302 72.2327C50.8212 69.5397 46.6267 69.3651 43.9293 71.8456C41.234 74.3264 41.0614 78.5229 43.5423 81.2183L76.9293 117.477C78.1521 118.806 79.8632 119.578 81.6676 119.616C81.7161 119.618 81.7628 119.618 81.8092 119.618C83.5627 119.618 85.2495 118.921 86.4921 117.683L170.955 33.4418C173.55 30.8551 173.555 26.6542 170.968 24.0606Z"
                fill="#2F2D2C"
              />
              <path
                d="M169.367 81.3667C165.703 81.3667 162.734 84.336 162.734 88C162.734 129.21 129.21 162.734 88 162.734C46.7926 162.734 13.2663 129.21 13.2663 88C13.2663 46.7926 46.7926 13.2663 88 13.2663C91.6637 13.2663 94.6333 10.297 94.6333 6.63334C94.6333 2.96931 91.6637 0 88 0C39.4762 0 0 39.4762 0 88C0 136.522 39.4762 176 88 176C136.522 176 176 136.522 176 88C176 84.3363 173.031 81.3667 169.367 81.3667Z"
                fill="#2F2D2C"
              />
            </svg>

            <svg
              v-if="modelValue.type == 'error'"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <svg
              v-if="modelValue.type == 'info'"
              xmlns="http://www.w3.org/2000/svg"
              class="h-36 w-36 text-gray-800"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
